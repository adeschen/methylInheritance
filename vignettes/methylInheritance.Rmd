...
demoForTransgenerationalAnalysis[[1]]@treatment
demoForTransgenerationalAnalysis[[2]]@treatment
demoForTransgenerationalAnalysis[[3]]@treatment
```
...
*runObservationUsingMethylKitInfo()* function.
...
*runPermutationUsingMethylKitInfo()* function.
...
*runPermutationUsingMethylKitInfo()* function, this step can be skipped.


## Extract a specific analysis

The *runPermutationUsingMethylKitInfo()* and 
