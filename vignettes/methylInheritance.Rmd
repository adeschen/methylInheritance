...
separately using real dataset with `r Rpackage("methylKit")`.
...
Each generation is analysed separately using `r Rpackage("methylKit")` package.
...
The *runPermutation()* and 
*runObservation()* functions 
